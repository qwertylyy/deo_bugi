...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {else}
        <h2 class="h4 title-address">{l s='Shipping Address' d='Shop.Theme.Checkout'}</h2>
      {/if}
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}" class="btn btn-outline">{l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        <h2 class="h5 title-address">{l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h2>
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}" class="btn btn-outline">{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
      ...
      {if !$form_has_continue_button}
        <div class="clearfix">
          <button type="submit" class="btn btn-outline continue float-sp-right" name="confirm-addresses" value="1">
