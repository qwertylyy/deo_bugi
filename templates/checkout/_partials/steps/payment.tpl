...
{block name='step_content'}
        ...
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
              <label class="custom-checkbox label-inherit">
                ...
                <span class="js-terms label-inherit" for="conditions_to_approve[{$condition_name}]">
                  {$condition nofilter}
                </span>
              </label>
          </li>
  ...
  <div id="payment-confirmation" class="js-payment-confirmation">
    <div class="ps-shown-by-js">
      <button type="submit" class="btn btn-outline center-block{if !$selected_payment_option} disabled{/if}">
