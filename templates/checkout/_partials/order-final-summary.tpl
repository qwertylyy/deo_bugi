...
<section id="order-summary-content" class="page-content page-order-confirmation">
  <div class="row">
    <div class="col-md-12">
      <h4 class="h4 black title-check-order">{l s='Please check your order before payment' d='Shop.Theme.Checkout'}</h4>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Addresses' d='Shop.Theme.Checkout'}
        <span class="step-edit step-to-addresses js-edit-addresses"><i class="deo-custom-icons edit"></i> {l s='Edit' d='Shop.Theme.Actions'}</span>
      </h4>
    </div>
  </div>
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        {l s='Shipping Method' d='Shop.Theme.Checkout'}
          <span class="step-edit step-to-delivery js-edit-delivery"><i class="deo-custom-icons edit"></i> {l s='Edit' d='Shop.Theme.Actions'}</span>
        </h4>
