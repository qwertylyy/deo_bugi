...
{block name='address_selector_blocks'}
  {foreach $addresses as $address}
    ...
    >
      <header>
        <label class="radio-block label-inherit">
          ...
          <span class="address-alias h5">{$address.alias}</span>
      ...
      <footer class="address-footer">
        {if $interactive}
          ...
          >
            <i class="deo-custom-icons edit"></i> {l s='Edit' d='Shop.Theme.Actions'}
          </a>
          <a
          ...
          >
            <i class="deo-custom-icons delete"></i> {l s='Delete' d='Shop.Theme.Actions'}
          </a>
        {/if}
      </footer>
    </article>
