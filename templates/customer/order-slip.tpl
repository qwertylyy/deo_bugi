...
{block name='page_title_sidebar'}
  <h1 class="page-title">{l s='Credit slips' d='Shop.Theme.Customeraccount'}</h1>
{/block}
      ...
      {foreach from=$credit_slips item=slip}
        <div class="credit-slip">
          <ul>
            ...
            <li class="link">
              <a class="btn btn-sm btn-outline" href="{$slip.url}">{l s='View credit slip' d='Shop.Theme.Customeraccount'}</a>
            </li>
          </ul>
        </div>
      {/foreach}
