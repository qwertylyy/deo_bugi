...
{block name='page_content'}
	<form action="{$urls.pages.password}" class="forgotten-password" method="post">
		...
		<section class="form-fields ">
			<div class="form-group center-email-fields form-group-input email row">
				<label class="col-md-12 form-control-label label-inherit required">{l s='Email address' d='Shop.Forms.Labels'}</label>
			...
			<div class="form-group button-submit-fields row text-sp-center">
				<div class="col-md-12">
					<button class="form-control-submit btn btn-outline" name="submit" type="submit">
