            ...
            {foreach from=$customizations.fields item="field"}
              <li class="product-customization-item">
                ...
                {if $field.type == 'text'}
                  ...
                  <small class="float-sp-right">{l s='250 char. max' d='Shop.Forms.Help'}</small>
                  {if $field.text !== ''}
                ...
                {elseif $field.type == 'image'}
                  ...
                  <span class="custom-file">
                    ...
                    <button class="btn btn-outline">{l s='Choose file' d='Shop.Theme.Actions'}</button>
                  </span>
                  <small class="float-sp-right">{l s='.png .jpg .gif' d='Shop.Forms.Help'}</small>
                {/if}
              </li>
            {/foreach}
          </ul>
          <div class="clearfix">
            <button class="btn btn-outline float-sp-right" type="submit" name="submitCustomizedData">{l s='Save Customization' d='Shop.Theme.Actions'}</button>
          </div>
        </form>
      {/block}
