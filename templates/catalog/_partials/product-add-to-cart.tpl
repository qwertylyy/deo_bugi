	...
	{if !$configuration.is_catalog}
		{block name='product_quantity'}
			<div class="product-quantity">
				...
				<div class="add">
					<button class="btn btn-outline add-to-cart" data-button-action="add-to-cart" type="submit" data-toggle="ui-tooltip" data-position="top" title="{$text_title}"{if !$product.add_to_cart_url} disabled{/if}>
