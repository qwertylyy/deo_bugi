...
{/if}
<section class="viewed-products block title-normal title-center title-uppercase button-middle button-hover clearfix">
  <div class="box-title">
    <h2 class="title_block">{l s='Viewed products' d='Shop.Theme.Global'}</h2>
  </div>
  <div class="block_content">
    <div class="products">
      <div class="slick-row">
        <div id="viewed-products" class="slick-carousel deo-carousel slick-slider deo-carousel-loading {(isset($productClassWidget) && $productClassWidget) ? $productClassWidget : ''}" 
