...
<section class="featured-products clearfix block title-normal title-center title-uppercase button-middle button-hover">
  ...
  <div class="block_content">
    <div class="products">
      <div class="slick-row">
        <div id="featured-products" class="slick-carousel deo-carousel slick-slider deo-carousel-loading {(isset($productClassWidget) && $productClassWidget) ? $productClassWidget : ''}" 
