 ...
 *}
<div id="cart-block" class="cart-block deo_class">
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header">
      ...
      {/if}
        ...
        <span class="title-cart"><span class="title-small">{l s='Cart' d='Shop.Theme.Global'}</span><span class="title-long">{l s='Shopping Cart' d='Shop.Theme.Global'}</span></span>
        <span class="cart-products-count">
          {if $cart.products_count > 0}
            <span class="cart-count">{if $cart.products_count > 0}{$cart.products_count}{/if}</span>
