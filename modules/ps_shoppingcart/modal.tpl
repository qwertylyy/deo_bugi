          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <div class="cart-content-btn">
                <button type="button" class="btn btn-outline" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
                <a href="{$cart_url}" class="btn btn-outline"><i class="material-icons rtl-no-flip">&#xE876;</i>{l s='Proceed to checkout' d='Shop.Theme.Actions'}</a>
              </div>
            </div>
          </div>
        </div>
