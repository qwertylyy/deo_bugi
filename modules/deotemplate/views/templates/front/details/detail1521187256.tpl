...
{block name='page_content_container'}
  <section class="page-content" id="content" data-col="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12" data-type="gallery" data-lazyload="1" data-thumb="bottom" data-breakpoints="[[1200, 5],[992, 4],[768, 3], [576, 2]]" data-modal="0" data-column_xxl="1" data-column_xl="1" data-column_lg="1" data-column_md="1" data-column_sm="1" data-column_xs="1" data-column_sp="1" data-size="large_default" data-zoom="out_scrooll" data-active="1">
    {block name='page_content'}
      {block name='product_cover_thumbnails'}
        {include file='catalog/_partials/product-cover-thumbnails.tpl' col_thumbnail="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12" size="large_default" lazyload=true gallery=true}
      {/block}
    {/block}
  </section>
{/block}
...
{/block}</div><div class="deo-block-fixed col-xxl-5 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-sp-12">
