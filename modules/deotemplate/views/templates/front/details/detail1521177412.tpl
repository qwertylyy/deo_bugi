...
<section id="main" class="product-detail" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">
{block name='page_content_container'}
  <section class="page-content" id="content" data-col="col-xxl-4 col-xl-4 col-lg-12 col-md-6 col-sm-6 col-xs-6 col-sp-12" data-type="gallery" data-lazyload="1" data-thumb="bottom" data-breakpoints="[[1200, 5],[992, 4],[768, 3], [576, 2]]" data-modal="0" data-column_xxl="3" data-column_xl="3" data-column_lg="1" data-column_md="2" data-column_sm="2" data-column_xs="2" data-column_sp="1" data-size="medium_default" data-zoom="in" data-active="1">
    {block name='page_content'}
      {block name='product_cover_thumbnails'}
        {include file='catalog/_partials/product-cover-thumbnails.tpl' col_thumbnail="col-xxl-4 col-xl-4 col-lg-12 col-md-6 col-sm-6 col-xs-6 col-sp-12" size="medium_default" lazyload=true gallery=true}
      {/block}
    {/block}
  </section>
{/block}
...
{/block}</div><div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 col-sp-12">
...
{/block}</div><div class="col-xxl-8 col-xl-8 col-lg-8 col-md-7 col-sm-12 col-xs-12 col-sp-12">
...
{/block}</div><div class="col-xxl-4 col-xl-4 col-lg-4 col-md-5 col-sm-12 col-xs-12 col-sp-12">
...
<div class="product-actions">
  ...
  {/block}
</div></div><div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">
{block name='hook_display_reassurance'}
  {hook h='displayReassurance'}
{/block}</div></div><div class="row"><div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 col-sp-12">

{include file="sub/product_info.tpl" type="accordions"}
