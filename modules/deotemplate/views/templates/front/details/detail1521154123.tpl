...
<section id="main" class="product-detail" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xxl-8 col-xl-7 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-sp-12">
...
{/block}</div><div class="deo-block-fixed  col-xxl-4 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-sp-12">
...
{include file="sub/product_info.tpl" type="tab"}
