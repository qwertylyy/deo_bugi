...
<div id="deoonepagecheckout-account" class="opc-checkout-element primary-block ">
...
<div id="deoonepagecheckout-address" class="opc-checkout-element primary-block ">
    <div class="block-inner">
        {include file='module:deotemplate/views/templates/front/onepagecheckout/blocks/address.tpl'}
    </div>
</div>

<div id="deoonepagecheckout-shipping" class="opc-checkout-element primary-block ">
    <div class="block-inner">
...
<div id="deoonepagecheckout-payment" class="opc-checkout-element primary-block ">
	<div class="block-inner">
...
<div id="deoonepagecheckout-cart-summary" class="opc-checkout-element ">
	<div class="block-inner">
