...
{include file="module:deotemplate/views/templates/hook/products/product_thumbnail.tpl" product=$product second_image="1" deo_size="home_default" labelflag="newdiscount"}
...
{include file="module:deotemplate/views/templates/hook/products/product_name.tpl"}<div class="box-button clearfix">
...
{hook h='displayDeoProductAtribute' product=$product show_name_attribute="false" show_value_text="false" show_color="true"}
