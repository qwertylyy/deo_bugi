...
<section class="category-products block title-normal title-center button-middle button-hover has-sub-title clearfix">
  <div class="box-title">
    ...
    <div class="sub-title-widget">
      {if $products|@count == 1}
        ({l s='There is %s other product in the same category' sprintf=[$products|@count] d='Shop.Theme.Global'})
      {else}
  ...
  <div class="block_content">
    <div class="products">
      <div class="slick-row">
        <div id="category-products" class="slick-carousel deo-carousel slick-slider deo-carousel-loading {(isset($productClassWidget) && $productClassWidget) ? $productClassWidget : ''}" 
